 ...
 */
final class Version20220906172722 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE commande (id INT AUTO_INCREMENT NOT NULL, chambre_id INT NOT NULL, date_arrivee DATE NOT NULL, date_depart DATE NOT NULL, prix_total INT NOT NULL, prenom VARCHAR(20) NOT NULL, nom VARCHAR(20) NOT NULL, telephone VARCHAR(20) NOT NULL, email VARCHAR(50) NOT NULL, date_enregistrement DATETIME NOT NULL, UNIQUE INDEX UNIQ_6EEAA67D9B177F54 (chambre_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, pseudo VARCHAR(180) NOT NULL, roles LONGTEXT NOT NULL COMMENT \'(DC2Type:json)\', password VARCHAR(255) NOT NULL, nom VARCHAR(255) NOT NULL, prenom VARCHAR(255) NOT NULL, telephone VARCHAR(255) NOT NULL, civilite VARCHAR(10) NOT NULL, date_enregistrement DATETIME NOT NULL, email VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_8D93D64986CC499D (pseudo), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
